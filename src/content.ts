...
export const letter = [
  ...
  "爱情和亲情的关系又是什么样的？我看到过这样的说法，为什么夫妻是财产的第一继承人而非子女，因为相比于本能的亲情，爱情是基于契约关系所形成的，因此法律更相信爱情所带来的理性的契约关系，而不是亲情所承载的父母与子女之间的关系。那爱情会变为亲情吗？我觉得会哎，并且相比于父母和子女之间的亲情，爱情所转化为的亲情更理性，也更有厚度（当然并不是所有的爱情和婚姻都是如此。恩爱这个词很神奇，似乎也只有中国才有这样的表达，而且恩排在爱之前，虽然可能是音律等各种因素的影响 哈哈哈哈 恩爱和浪漫爱应该是不一样的，当然这些概念受到各种国内外思潮的影响，其关系我也没办法理清，这里提到是因为想给你说谢谢你~",
